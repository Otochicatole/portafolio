    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className="flex flex-col w-[98%] h-[98%] transition-all ease-in-out duration-1000  border border-neutral-800 rounded-lg overflow-hidden hover:shadow-[0_0_30px_10px_rgba(200,200,255,0.1),_inset_0_0_55px_10px_rgba(0,0,0,0.5)]">
                    <div className="flex flex-row -h-[45px] bg-neutral-800 w-full">
                        <div className="flex flex-row items-end w-full">
                            <div className="flex flex-col items-center">
                                <div
                                    className="flex flex-row justify-between items-center ml-[10px] relative bg-neutral-950 w-[150px] lg:w-[250px] h-[30px] transition-all  py-[19px] px-3 rounded-t-lg">
                                    ...
                                    <span className="absolute bg-neutral-950 bottom-0 -left-2 w-2 h-2">
                                    <span className="block w-2 h-2 bg-neutral-800  rounded-br-full "/>
                                </span>
                                    <span className="absolute bg-neutral-950 bottom-0 -right-2 w-2 h-2">
                                    <span className="block w-2 h-2 bg-neutral-800  rounded-bl-full "/>
                                </span>
                                </div>
                            </div>
