            ...
            <div
                ...
                {minimizeTerminal && (
                    <motion.div
                        ...
                        style={{zIndex: 999}}
                        className="bg-neutral-950 fixed border-t border-l border-r border-neutral-700 bottom-0 right-10 flex flex-row gap-3 items-center justify-between pr-3 w-[300px] rounded-t-lg mt-20 cursor-pointer hover:bg-white/10 backdrop-blur-3xl"
                    >
                ...
                {closeTerminal && (
                    <motion.div
                        ...
                        className="bg-white/5 flex flex-row gap-3 items-center justify-center p-3 w-[300px] h-[300px] rounded-lg mt-20 cursor-pointer hover:bg-white/10"
                    >
